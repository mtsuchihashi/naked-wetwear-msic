...
function Intro() {
    ...
    return (
        <div className="container my-4">
            <h2 className="card-title text-info font-weight-bold">Naked Wetwear Side: Misc.</h2>
            <p className="card-subtitle mt-2">日常系ブログ</p>
            {/* <Link className="btn btn-info my-3" to="about">Know More</Link> */}
            <a href="https://naked-wetware.hatenablog.jp">Tech Blog</a>
